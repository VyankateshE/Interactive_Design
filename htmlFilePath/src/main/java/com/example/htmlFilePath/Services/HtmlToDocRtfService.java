...
//        // Read HTML and apply inline styles
...
//
//        // Inline background colors for table headers that have styles in <style> blocks
...
//        }
//
//        // Inline styles for all table cells and headers with background-color defined in CSS
//        for (Element elem : doc.select("[id^=json-table-c1301-colheader], [id^=json-table-c1301-rowheader], [id^=json-table-c1301-cell]")) {
//            String id = elem.id();
//
//            // Check the original CSS selectors that have background-color
...
//        }
//
//        // Keep your button styling logic
